...
public class SearchWithWrongLocator extends BaseTest {
    ...
    public void searchAndBuyIPhone() {
        ...
        setReportName("Wrong Locator - Test Case 3");
        startTest("Wrong Locator - Test Case 3");
        ...
        try {
            ...
            test.fail("Incorrect Locator - Test Failed.").addScreenCaptureFromPath(screenshotPath3).fail(e.getMessage());
        }
    }
